...
function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  || pathname.includes('alert') || pathname.includes('search') || pathname.includes('magazine') || pathname.includes('board/') || pathname.includes('maintenance') || pathname.includes('signup') || isMaintenance || pathname.includes('withdrawal');
