      ...
      <div className="scrollbar-none flex w-full flex-col px-5">
        ...
        <div className="scrollbar-none flex flex-col gap-[1.88rem] overflow-y-auto pb-24">
          <div className="text-[0.875rem] text-gray100">
            <h2 className="text-4 mb-4 font-bold text-gray100">제1조 (위치정보 수집 항목)</h2>
          ...
          <div className="text-[0.875rem] text-gray100">
            <h2 className="text-4 mb-4 font-bold text-gray100">제2조 (이용 목적)</h2>
            <div className="space-y-3">
          ...
          <div className="text-[0.875rem] text-gray100">
            <h2 className="text-4 mb-4 font-bold text-gray100">제3조 (보유 기간 및 파기)</h2>
            <div className="space-y-3">
          ...
          <div className="text-[0.875rem] text-gray100">
            <h2 className="text-4 mb-4 font-bold text-gray100">제4조 (이용자의 권리)</h2>
            <div className="space-y-3">
