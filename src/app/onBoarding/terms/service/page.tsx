      ...
      <div className="scrollbar-none flex w-full flex-col px-5">
        ...
        <div className="scrollbar-none flex flex-col gap-[1.88rem] overflow-y-auto pb-24">
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제1조 (목적)</h2>
            <p className="">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제2조 (용어 정의)</h2>
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제3조 (약관의 효력 및 변경)</h2>
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제4조 (회원가입 및 이용계약 체결)</h2>
            <div className="space-y-3">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제5조 (서비스 내용)</h2>
            <div className="space-y-3">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제6조 (이용 제한 및 계약 해지)</h2>
            <div className="space-y-1">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제7조 (게시물 관리 및 저작권)</h2>
            <div className="space-y-1">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제8조 (개인정보 수집 및 활용)</h2>
            <div className="space-y-1">
              <p>
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제9조 (서비스 변경·중단)</h2>
            <div className="space-y-1">
              <p>
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제10조 (면책 조항)</h2>
            <div className="space-y-1">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제11조 (분쟁해결 및 관할)</h2>
            <p>
