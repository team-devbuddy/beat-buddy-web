      ...
      <div className="scrollbar-none flex w-full flex-col px-5">
        ...
        <div className="scrollbar-none flex flex-col gap-[1.88rem] overflow-y-auto pb-24">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제1조 (수신 정보 항목)</h2>
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제2조 (발송 수단)</h2>
            <div className="space-y-1">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제3조 (철회 및 설정 변경)</h2>
            <div className="space-y-1">
          ...
          <div className="text-body-14-medium text-gray100">
            <h2 className="mb-3 text-button-16-semibold text-gray100">제4조 (기타사항)</h2>
            <div className="space-y-1">
