...
const BoardDetailPage = ({ params }: { params: { venueId: string } }) => {
  ...
  useEffect(() => {
    ...
    console.log('현재 게시글 ID:', params.venueId);
    console.log('전체 게시글:', mockBoardData);
    
    const foundPost = mockBoardData.find(post => post.id === params.venueId);
