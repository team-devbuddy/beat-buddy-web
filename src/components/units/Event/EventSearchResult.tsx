...
export default function EventSearchResult({ eventId, event }: PostProps) {
  ...
  return (
    <div className="border-b border-gray700 bg-BG-black px-[1.25rem] py-[1.12rem]">
      ...
      <p className="mt-[0.88rem] whitespace-pre-wrap text-[0.75rem] text-gray100">{event.content}</p>
      ...
      {isModalOpen && event.images && (
        <BoardImageModal images={event.images} initialIndex={currentImageIndex} onClose={() => setIsModalOpen(false)} />
      )}
