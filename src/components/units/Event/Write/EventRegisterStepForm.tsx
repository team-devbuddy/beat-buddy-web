      ...
      <div className="mb-6 flex gap-2">
        <motion.button
          ...
          className={classNames(
            'flex-1 rounded-[0.38rem] py-3',
            isReceivingInfo === true
              ? 'text-body-14-semibold border border-main bg-sub1 text-white'
              : 'text-body-14-semibold bg-gray500 text-gray300',
          )}>
          받을게요
        </motion.button>
        <motion.button
                ...
                <div className="flex items-center gap-4 pb-[0.62rem]">
                  ...
                  <div
                    ...
                    <input
                      ...
                      className="w-[80px] bg-transparent text-center text-body-14-medium text-white placeholder-gray300 safari-input-fix focus:outline-none"
                    />
                  </div>
                  ...
                  <div
                    ...
                    <input
                      ...
                      className="w-full bg-transparent text-body-14-medium text-white placeholder-gray300 safari-input-fix focus:outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div
                    ...
                    <input
                      ...
                      className="w-full bg-transparent text-right text-body-14-medium text-white placeholder-gray300 safari-input-fix focus:outline-none"
                    />
