    ...
    <div
      ...
      <motion.div
        ...
        <div className="flex w-full">
          <button onClick={onClose} className="flex-1 bg-gray300 py-4 font-bold text-BG-black">
            아니요
          </button>
          <button onClick={onConfirm} className="flex-1 bg-main py-4 font-bold text-BG-black">
            네, 추천해주세요
          </button>
        </div>
      </motion.div>
