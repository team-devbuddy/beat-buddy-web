...
export default function BusinessMyPage() {
    ...
    const fetchNickname = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setBusinessName(profileInfoResponse?.data?.businessName);
        }
      } catch (error) {
  ...
  return (
    <div className="flex flex-col">
        ...
        <Swiper
          ...
          <SwiperSlide>
            <div
              ...
              <div className="flex h-full flex-col justify-between">
                {/* 프로필 정보 */}
                <div className="mb-[1.81rem] flex items-start justify-between">
                  <div className="flex items-start gap-4">
                    <div className="flex flex-col items-start justify-center">
                      <div className="flex items-center gap-2">
                        <span className="text-button-bold text-white">{businessName}버디</span>
                        <Image src="/icons/Frame 60.svg" alt="편집" width={14} height={14} />
                      </div>
                      <span className="text-body3-12-medium text-white/70">비즈니스 회원</span>
                    </div>
                  </div>
                  <button className="rounded-[0.5rem] bg-[#131415]/20 px-2 py-[0.19rem] text-[0.6875rem] text-white/80">
                    메인 프로필
                  </button>
                </div>
          ...
          <SwiperSlide>
            <div
              ...
              <div className="flex h-full flex-col justify-between">
                {/* 프로필 정보 */}
                <div className="mb-[1.69rem] flex items-start justify-between">
                  <div className="flex items-start gap-4">
                  ...
                  <button className="rounded-[0.5rem] bg-[#131415]/20 px-2 py-[0.19rem] text-body-11-medium text-white/80">
                    커뮤니티 프로필
                  </button>
                </div>
                ...
                <div className="">
                  <div className="flex items-center gap-[0.31rem]">
                    <div
                      ...
                      className="w-full rounded-[0.5rem] bg-[#17181C]/50 px-2 py-[0.88rem] text-center text-body-13-bold text-white">
                      커뮤니티 프로필 바로가기
                    </div>
                  </div>
                </div>
      ...
      {/* My Coupon */}
      <div className="mx-5 mb-[0.62rem] rounded-lg bg-[#28292A] p-4 text-body-15-bold">
      ...
      {/* 하단 링크들 */}
      <div className="">
        <Link href="/inquiry" className="flex items-center justify-between px-5 py-4 text-body-15-bold">
