  ...
  return (
    <>
      {isMapView ? (
        ...
        <div
          className="z-5 fixed bottom-28 left-1/2 flex -translate-x-1/2 transform cursor-pointer items-center justify-center rounded-full bg-main px-[1.25rem] py-[0.75rem] text-body3-12-bold text-BG-black transition duration-150 ease-in-out hover:shadow-[0_0_0_3px_rgba(255,255,255,0.3)] active:scale-95"
          onClick={toggleViewMode}>
