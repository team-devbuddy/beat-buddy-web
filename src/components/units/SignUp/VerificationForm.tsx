  ...
  return (
    <>
      ...
      <div className="bg-BG-black px-5 text-white">
        <h1 className="pb-[1.88rem] pt-[0.62rem] text-[1.5rem] font-bold">인증번호를 입력해주세요</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={loading}
            className="whitespace-nowrap rounded-[0.5rem] bg-gray700 px-3 py-2 text-[0.75rem] font-bold text-main"
            title="확인">
            확인
          </button>
        </div>

        <p className="mt-2 text-[0.75rem] text-gray200">
        ...
        <div className="fixed bottom-5 left-0 w-full px-5">
          <button
            ...
            className={`w-full rounded-[0.5rem] py-[0.81rem] font-bold ${
              verified ? 'bg-main text-BG-black' : 'bg-gray400 text-gray300'
            }`}>
            다음
          </button>
        </div>
