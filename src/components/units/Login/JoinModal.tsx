...
export default function JoinModal({ onClose, loginType, onBusinessClick }: Props) {
  ...
  return (
    ...
    >
      <div className="flex gap-3 animate-pop">
        ...
        {/* 비즈니스 카드 */}
        <div onClick={onBusinessClick} className="flex py-8 px-8 bg-[#480522] border border-main rounded-md text-white hover:scale-105 transition-transform duration-200 cursor-pointer">
          <div className="flex flex-col h-full justify-between items-center text-center">
            <div>
