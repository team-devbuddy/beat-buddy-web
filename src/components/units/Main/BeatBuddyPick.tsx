      ...
      <div className="flex overflow-x-auto hide-scrollbar snap-x snap-mandatory space-x-[0.5rem] px-[1rem]">
        {clubs.map((club) => (
          <Link key={club.id} href={`/detail/${club.id}`} passHref>
            <div className="relative custom-club-card min-w-[15rem] mt-[0.5rem] rounded-md overflow-hidden snap-center cursor-pointer">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                ...
                <div className="flex items-center space-x-[0.25rem] text-gray300 text-body3-12-medium mt-[1.03rem] z-100">
