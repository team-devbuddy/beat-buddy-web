  ...
  return (
    <div className="flex flex-col mt-[0.44rem]">
      <div className="flex items-center justify-between px-[1rem] py-[1.25rem]">
        <span className="text-main2 font-queensides text-[1.5rem]">BeatBuddy Pick</span> {/*고치기*/}
          ...
          <div key={club.id} className="relative custom-club-card min-w-[15rem] mt-[0.5rem] rounded-md overflow-hidden snap-center">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
              <div className="flex space-x-[0.75rem] mb-[0.75rem]">
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border-xs">{club.location}</span>
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border-xs">{club.genre1}</span>
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border-xs">{club.genre2}</span>
              </div>
