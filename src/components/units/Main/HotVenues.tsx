          ...
          <div key={venue.id} className="relative flex flex-col">
            ...
            <div className="mt-[1rem]">
              ...
              <div className="flex flex-wrap gap-[0.5rem] mt-[0.75rem] mb-[1.06rem]">
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border border-gray500 rounded-xs">{venue.location}</span>
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border border-gray500 rounded-xs">{venue.genre1}</span>
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border border-gray500 rounded-xs">{venue.genre2}</span>
              </div>
