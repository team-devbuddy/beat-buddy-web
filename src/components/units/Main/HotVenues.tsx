  ...
  return (
    <div className="flex flex-col mt-[1.5rem]">
      <div className="flex flex-col items-start justify-between px-[1rem] py-[0.5rem]">
        <span className="text-main2 font-queensides text-lg">Hot</span> {/*고치기*/}
          ...
          <div key={venue.id} className="relative flex flex-col">
            ...
            <div className="mt-[1rem]">
              ...
              <div className="flex flex-wrap gap-[0.5rem] mt-[0.75rem] mb-[1.06rem]">
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border-xs">{venue.location}</span>
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border-xs">{venue.genre1}</span>
                <span className="bg-gray500 text-gray100 text-body3-12-medium px-[0.38rem] py-[0.13rem] border-xs">{venue.genre2}</span>
              </div>
